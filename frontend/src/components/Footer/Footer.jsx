    ...
    <footer className="bg-gray-900 text-gray-200 py-8 mt-12">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
        ...
        <div className="hidden md:flex flex-col gap-2 text-gray-400 text-sm ml-8">
          ...
          <span>New Baneswor, Kathmandu</span>
        </div>
        <div className="flex gap-4 mt-6 md:mt-0 md:flex-col">
          <a href="https://www.facebook.com/profile.php?id=100091491859245" aria-label="Facebook" className="hover:text-blue-500 transition">
            <FaFacebookF size={22} />
          </a>
          <a href="https://www.instagram.com/amritpaudel294/" aria-label="Instagram" className="hover:text-pink-400 transition">
            <FaInstagram size={22} />
          </a>
        </div>
      </div>
